...
function HS_calender() {
    ...
    style += ".calender { width:200px; height:auto; font-size:11px; margin-right:14px; background-color:#F9F9F9;; border:1px solid #397EAE; padding:1px}";
    ...
    style += ".calender .day li{ float:left; width:10%; height:20px; line-height:20px; text-align:center}";
    style += ".calender .date li{ float:left; width:10%; height:20px; line-height:20px; text-align:center}";
